//
//  SeeTheAppGamesSubcategoriesMenuViewController.m
//  SeeTheApp
//
...
@implementation SeeTheAppGamesSubcategoriesMenuViewController
...
{
    NSInteger category = [[[[[self delegate] gameCategoriesInfo] objectAtIndex:argButtonIndex] valueForKey:@"CategoryCode"] integerValue];
    [[self delegate] gamesSubcategoriesMenuCategorySelected:category];
}
...
- (NSArray*)allMenuItems
{
    ...
    NSArray *gameCategoryDicts = [[self delegate] gameCategoriesInfo];
    for (NSDictionary *gameCategoryDict in gameCategoryDicts)
    {
        [tempAllMenuItems_gv addObject:[gameCategoryDict valueForKey:@"CategoryName"]];
    }
